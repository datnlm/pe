...
import truonglt.sax.ItemHandler;
...
public class SearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            String fromPoint = request.getParameter("txtFromPoint");
            String toPoint = request.getParameter("txtToPoint");

            String realPath = getServletContext().getRealPath("/");
            String filePath = realPath + XMLFILE;

            ItemHandler handler = new ItemHandler(fromPoint, toPoint);
            XMLUtils.parseFileWithSAX(filePath, handler);

            List<ItemDTO> listItem = handler.getListItem();
            if (listItem != null) {
